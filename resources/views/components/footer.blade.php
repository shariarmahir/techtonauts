        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-8 flex flex-col items-center lg:items-start">
                ...
                <div class="flex justify-center lg:justify-start space-x-4">
                    <a href="https://www.facebook.com/share/15wsTJnny9/" class="social-link-footer group relative">
                    ...
                    <a href="https://www.linkedin.com/feed/?trk=404_page" class="social-link-footer group relative">
                    ...
                    <a href="https://www.instagram.com/tech_to_nauts/" class="social-link-footer group relative">
