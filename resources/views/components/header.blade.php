            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-3 bg-gradient-to-r from-gray-800/60 via-purple-800/70 to-gray-800/60 backdrop-blur-xl border border-purple-500/30 rounded-2xl px-4 py-2 shadow-2xl">
                        <a href="https://github.com/techtonauts" class="group relative">
                            <div class="absolute -inset-2 bg-gradient-to-r from-gray-600/60 to-gray-800/60 opacity-0 group-hover:opacity-100 blur-lg transition-all duration-500 rounded-full"></div>
                            <div class="relative p-3 rounded-full bg-gradient-to-br from-gray-700/50 to-gray-900/70 backdrop-blur-xl border border-gray-600/40 hover:border-gray-400/60 transition-all duration-500 transform hover:scale-125 hover:-translate-y-1 hover:rotate-6 shadow-lg hover:shadow-2xl hover:shadow-gray-500/30">
                        ...
                        <a href="https://linkedin.com/company/techtonauts" class="group relative">
                        ...
                        <a href="https://instagram.com/techtonauts" class="group relative">
